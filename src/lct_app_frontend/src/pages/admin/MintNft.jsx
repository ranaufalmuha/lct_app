...
const MintNft = () => {
    ...
    const [name, setName] = useState('Lost Black');
    const [owner, setOwner] = useState('bd3sg-teaaa-aaaaa-qaaba-cai');
    ...
    return (
        <div className='container'>
            ...
            <form className='p-7'>
                ...
                <div class="mb-4">
                    <label for="text" class="block mb-2 text-sm font-medium text-gray-900 ">NFT Name</label>
                    <input type="text" value={name} onChange={(e) => setName(e.target.value)} required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="principal" />
                </div>
                <div class="mb-6">
